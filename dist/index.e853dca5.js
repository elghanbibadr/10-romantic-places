...
*/ !function(e, t) {
    ...
    var m = Object.assign || function(e) {
        ...
        if (e) {
            var t = function(e) {
                return [].slice.call(e);
            }, i = 0, a = 1, n = 2, s = 3, r = [], o = null, l = "requestAnimationFrame" in e ? function() {
    ...
    class b {
        ...
        load(e, i = {}) {
            ...
            if (a) {
                ...
                let t = e.slideBackgroundContentElement, n = e.getAttribute("data-background-iframe");
                if (!1 === a.hasAttribute("data-loaded")) {
                    a.setAttribute("data-loaded", "true");
                    let s = e.getAttribute("data-background-image"), r = e.getAttribute("data-background-video"), o = e.hasAttribute("data-background-video-loop"), l = e.hasAttribute("data-background-video-muted");
                    if (s) /^data:/.test(s.trim()) ? t.style.backgroundImage = `url(${s.trim()})` : t.style.backgroundImage = s.split(",").map((e)=>`url(${encodeURI(e.trim())})`).join(",");
            ...
            if ("function" == typeof i.slideNumber) t = i.slideNumber(e);
                ...
                switch(t = [], a){
                    ...
                    default:
                        ...
                        t.push(i1.h + n);
                        let s = "h/v" === a ? "/" : ".";
                        this.Reveal.isVerticalSlide(e) && t.push(s, i1.v + 1);
                }
            }
    ...
    class E {
        ...
        update(e = !1) {
            let i = this.Reveal.getCurrentSlide(), a = this.Reveal.getIndices(), n = null, s = this.Reveal.getConfig().rtl ? "future" : "past", r = this.Reveal.getConfig().rtl ? "past" : "future";
            if (Array.from(this.element.childNodes).forEach((i, o)=>{
                i.classList.remove("past", "present", "future"), o < a.h ? i.classList.add(s) : o > a.h ? i.classList.add(r) : (i.classList.add("present"), n = i), (e || o === a.h) && t(i, ".slide-background").forEach((e, t)=>{
                ...
                let t = this.previousBackground ? this.previousBackground.getAttribute("data-background-hash") : null, i = n.getAttribute("data-background-hash");
        ...
        updateParallax() {
            ...
            if (this.Reveal.getConfig().parallaxBackgroundImage) {
                let t, i, a = this.Reveal.getHorizontalSlides(), n = this.Reveal.getVerticalSlides(), s = this.element.style.backgroundSize.split(" ");
                ...
                let c, h, u = this.element.offsetHeight, g = n.length;
    ...
    const R = ".slides section", S = ".slides>section", A = ".slides>section.present>section", k = /registerPlugin|registerKeyboardShortcut|addKeyBinding|addEventListener|showPreview/, L = /fade-(down|up|right|left|out|in-then-out|in-then-semi-out)|semi-fade-out|current-visible|shrink|grow/;
    let C = 0;
    class x {
        constructor(e){
            this.Reveal = e;
        ...
        run(e, t) {
            this.reset();
            let i = this.Reveal.getSlides(), a = i.indexOf(t), n = i.indexOf(e);
            if (e.hasAttribute("data-auto-animate") && t.hasAttribute("data-auto-animate") && e.getAttribute("data-auto-animate-id") === t.getAttribute("data-auto-animate-id") && !(a > n ? t : e).hasAttribute("data-auto-animate-restart")) {
                ...
                if (s && (e.style.display = "none"), "false" !== t.dataset.autoAnimateUnmatched && !0 === this.Reveal.getConfig().autoAnimateUnmatched) {
                    ...
                    this.getUnmatchedAutoAnimateElements(t).forEach((e)=>{
                        ...
                        t.duration === i.duration && t.delay === i.delay || (a = "unmatched-" + C++, r.push(`[data-auto-animate="running"] [data-auto-animate-target="${a}"] { transition: opacity ${t.duration}s ease ${t.delay}s; }`)), e.dataset.autoAnimateTarget = a;
        ...
        autoAnimateElements(e, t, i, a, n) {
            ...
            if (t.classList.contains("fragment") && (delete o.styles.opacity, e.classList.contains("fragment"))) (e.className.match(L) || [
                ""
            ])[0] === (t.className.match(L) || [
                ""
            ...
            if (!1 !== i.translate || !1 !== i.scale) {
                ...
                let a = !1 !== i.translate && (0 !== t.x || 0 !== t.y), n = !1 !== i.scale && (0 !== t.scaleX || 0 !== t.scaleY);
                if (a || n) {
                    let e = [];
            ...
            if (d.length > 0) r.styles.transition = "none", o.styles.transition = `all ${s.duration}s ${s.easing} ${s.delay}s`, o.styles["transition-property"] = d.join(", "), o.styles["will-change"] = d.join(", "), l = '[data-auto-animate-target="' + n + '"] {' + Object.keys(r.styles).map((e)=>e + ": " + r.styles[e] + " !important;").join("") + '}[data-auto-animate="running"] [data-auto-animate-target="' + n + '"] {' + Object.keys(o.styles).map((e)=>e + ": " + o.styles[e] + " !important;").join("") + "}";
            return l;
        }
        ...
        getAutoAnimatableProperties(e, t, i) {
            ...
            return (i.styles || a.autoAnimateStyles).forEach((t)=>{
                ...
                "string" == typeof t && (t = {
                    ...
                    value: t.to,
                    explicitValue: !0
                } : ("line-height" === t.property && (i = parseFloat(s["line-height"]) / parseFloat(s["font-size"])), isNaN(i) && (i = s[t.property])), "" !== i && (n.styles[t.property] = i);
            }), n;
        }
        ...
        getAutoAnimatePairs(e, t) {
            ...
            return this.findAutoAnimateMatches(i, e, t, "[data-id]", (e)=>e.nodeName + ":::" + e.getAttribute("data-id")), this.findAutoAnimateMatches(i, e, t, a, (e)=>e.nodeName + ":::" + e.innerText), this.findAutoAnimateMatches(i, e, t, "img, video, iframe", (e)=>e.nodeName + ":::" + (e.getAttribute("src") || e.getAttribute("data-src"))), this.findAutoAnimateMatches(i, e, t, "pre", (e)=>e.nodeName + ":::" + e.innerText), i.forEach((e)=>{
                s(e.from, a) ? e.options = {
                    scale: !1
                } : s(e.from, "pre") && (e.options = {
                    scale: !1,
                    styles: [
                        "width",
                        "height"
    ...
    class N {
        ...
        activate() {
            if (this.Reveal.getConfig().overview && !this.isActive()) {
                this.active = !0, this.Reveal.getRevealElement().classList.add("overview"), this.Reveal.cancelAutoSlide(), this.Reveal.getSlidesElement().appendChild(this.Reveal.getBackgroundsElement()), t(this.Reveal.getRevealElement(), R).forEach((e)=>{
        ...
        deactivate() {
            if (this.Reveal.getConfig().overview) {
                ...
                }, 1), this.Reveal.getRevealElement().appendChild(this.Reveal.getBackgroundsElement()), t(this.Reveal.getRevealElement(), R).forEach((e)=>{
    ...
    class M {
        ...
        onDocumentKeyDown(e) {
            ...
            let n = document.activeElement && !0 === document.activeElement.isContentEditable, s = document.activeElement && document.activeElement.tagName && /input|textarea/i.test(document.activeElement.tagName), r = document.activeElement && document.activeElement.className && /speaker-notes/i.test(document.activeElement.className), o = !(-1 !== [
                32,
                37,
                38,
                39,
    ...
    class D {
        ...
        getIndicesFromHash(e = window.location.hash) {
            ...
            if (/^[0-9]*$/.test(i[0]) || !t.length) {
                ...
                let t, a = e.hashOneBasedIndex ? 1 : 0, n = parseInt(i[0], 10) - a || 0, s = parseInt(i[1], 10) - a || 0;
    ...
    class q {
        ...
        async setupPDF() {
            const e = this.Reveal.getConfig(), i = t(this.Reveal.getRevealElement(), R), a = e.slideNumber && /all|print/i.test(e.showSlideNumber), n = this.Reveal.getComputedSlideSize(window.innerWidth, window.innerHeight), s = Math.floor(n.width * (1 + e.margin)), r = Math.floor(n.height * (1 + e.margin)), o = n.width, d = n.height;
            await new Promise(requestAnimationFrame), l("@page{size:" + s + "px " + r + "px; margin: 0px;}"), l(".reveal section>img, .reveal section>video, .reveal section>iframe{max-width: " + o + "px; max-height:" + d + "px}"), document.documentElement.classList.add("print-pdf"), document.body.style.width = s + "px", document.body.style.height = r + "px";
            ...
            i.forEach(function(i, n) {
                if (!1 === i.classList.contains("stack")) {
                    ...
                    if (g.push(f), f.className = "pdf-page", f.style.height = (r + e.pdfPageHeightOffset) * m + "px", h && (f.style.background = h), f.appendChild(i), i.style.left = l + "px", i.style.top = c + "px", i.style.width = o + "px", this.Reveal.slideContent.layout(i), i.slideBackgroundElement && f.insertBefore(i.slideBackgroundElement, i), e.showNotes) {
                        ...
                        if (t) {
                            const i = 8, a = "string" == typeof e.showNotes ? e.showNotes : "inline", n = document.createElement("div");
                            n.classList.add("speaker-notes"), n.classList.add("speaker-notes-pdf"), n.setAttribute("data-layout", a), n.innerHTML = t, "separate-page" === a ? g.push(n) : (n.style.left = i + "px", n.style.bottom = i + "px", n.style.width = s - 2 * i + "px", f.appendChild(n));
                        }
                    }
                    if (a) {
            ...
            if (this.touchCaptured) v && e.preventDefault();
                ...
                if (1 === e.touches.length && 2 !== this.touchStartCount) {
                    let n = this.Reveal.availableRoutes({
                        includeFragments: !0
                    }), s = i - this.touchStartX, r = a - this.touchStartY;
    ...
    class V {
        ...
        render() {
            let e = this.playing ? this.progress : 0, t = this.diameter2 - this.thickness, i = this.diameter2, a = this.diameter2, n = 28;
            this.progressOffset += .1 * (1 - this.progressOffset);
            const s = -Math.PI / 2 + e * (2 * Math.PI), r = -Math.PI / 2 + this.progressOffset * (2 * Math.PI);
    ...
    function X(s, l) {
        ...
        const h = {};
        let u, v, p, m, f, w = {}, L = !1, C = {
            hasNavigatedHorizontally: !1,
            hasNavigatedVertically: !1
        }, z = [], O = 1, U = {
            layout: "",
            overview: ""
        }, X = {}, Y = "idle", _ = 0, G = 0, J = -1, Q = !1, Z = new b(h), ee = new y(h), te = new x(h), ie = new E(h), ae = new P(h), ne = new N(h), se = new M(h), re = new D(h), oe = new I(h), le = new T(h), de = new F(h), ce = new H(h), he = new q(h), ue = new W(h), ge = new B(h), ve = new K(h);
        function pe(e) {
            ...
            return w = {
                ...
                ...e,
                ...d()
            }, me(), window.addEventListener("load", Ue, !1), ce.load(w.plugins, w.dependencies).then(fe), new Promise((e)=>h.on("ready", e));
        }
        function me() {
        ...
        function fe() {
            L = !0, be(), ye(), ke(), Se(), Ae(), st(), Le(), re.readURL(), ie.update(!0), setTimeout(()=>{
                X.slides.classList.remove("no-transition"), X.wrapper.classList.add("ready"), Ie({
                    type: "ready",
                    data: {
                        indexh: u,
                        indexv: v,
            ...
            }, 1), he.isPrintingPDF() && (xe(), "complete" === document.readyState ? he.setupPDF() : window.addEventListener("load", ()=>{
                he.setupPDF();
            }));
        }
        function be() {
            w.showHiddenSlides || t(X.wrapper, 'section[data-visibility="hidden"]').forEach((e)=>{
                e.parentNode.removeChild(e);
            });
        }
        function ye() {
            X.slides.classList.add("no-transition"), g ? X.wrapper.classList.add("no-hover") : X.wrapper.classList.remove("no-hover"), ie.render(), ee.render(), oe.render(), le.render(), ve.render(), X.pauseOverlay = o(X.wrapper, "div", "pause-overlay", w.controls ? '<button class="resume-button">Resume presentation</button>' : null), X.statusElement = we(), X.wrapper.setAttribute("role", "application");
        }
        function we() {
            let e = X.wrapper.querySelector(".aria-status");
            return e || (e = document.createElement("div"), e.style.position = "absolute", e.style.height = "1px", e.style.width = "1px", e.style.overflow = "hidden", e.style.clip = "rect( 1px, 1px, 1px, 1px )", e.classList.add("aria-status"), e.setAttribute("aria-live", "polite"), e.setAttribute("aria-atomic", "true"), X.wrapper.appendChild(e)), e;
        }
        function Ee(e) {
        ...
        function Le(t) {
            ...
            X.wrapper.classList.remove(a.transition), X.wrapper.classList.add(w.transition), X.wrapper.setAttribute("data-transition-speed", w.transitionSpeed), X.wrapper.setAttribute("data-background-transition", w.backgroundTransition), X.viewport.style.setProperty("--slide-width", w.width + "px"), X.viewport.style.setProperty("--slide-height", w.height + "px"), w.shuffle && rt(), i(X.wrapper, "embedded", w.embedded), i(X.wrapper, "rtl", w.rtl), i(X.wrapper, "center", w.center), !1 === w.pause && Je(), w.previewLinks ? (Fe(), ze("[data-preview-link=false]")) : (ze(), Fe("[data-preview-link]:not([data-preview-link=false])")), te.reset(), f && (f.destroy(), f = null), n > 1 && w.autoSlide && w.autoSlideStoppable && (f = new V(X.wrapper, ()=>Math.min(Math.max((Date.now() - J) / _, 0), 1)), f.on("click", $t), Q = !1), "default" !== w.navigationMode ? X.wrapper.setAttribute("data-navigation-mode", w.navigationMode) : X.wrapper.removeAttribute("data-navigation-mode"), ve.configure(w, a), ue.configure(w, a), de.configure(w, a), oe.configure(w, a), le.configure(w, a), se.configure(w, a), ae.configure(w, a), ee.configure(w, a), at();
        }
        function Ce() {
            window.addEventListener("resize", Ut, !1), w.touch && ge.bind(), w.keyboard && se.bind(), w.progress && le.bind(), w.respondToHashChanges && re.bind(), oe.bind(), ue.bind(), X.slides.addEventListener("click", Ot, !1), X.slides.addEventListener("transitionend", Bt, !1), X.pauseOverlay.addEventListener("click", Je, !1), w.focusBodyOnPageVisibilityChange && document.addEventListener("visibilitychange", Wt, !1);
        }
        function xe() {
            ge.unbind(), ue.unbind(), se.unbind(), oe.unbind(), le.unbind(), re.unbind(), window.removeEventListener("resize", Ut, !1), X.slides.removeEventListener("click", Ot, !1), X.slides.removeEventListener("transitionend", Bt, !1), X.pauseOverlay.removeEventListener("click", Je, !1);
        }
        function Pe() {
            xe(), xt(), ze(), ve.destroy(), ue.destroy(), ce.destroy(), de.destroy(), oe.destroy(), le.destroy(), ie.destroy(), ee.destroy(), document.removeEventListener("fullscreenchange", Kt), document.removeEventListener("webkitfullscreenchange", Kt), document.removeEventListener("visibilitychange", Wt, !1), window.removeEventListener("message", qt, !1), window.removeEventListener("load", Ue, !1), X.pauseOverlay && X.pauseOverlay.remove(), X.statusElement && X.statusElement.remove(), document.documentElement.classList.remove("reveal-full-page"), X.wrapper.classList.remove("ready", "center", "has-horizontal-slides", "has-vertical-slides"), X.wrapper.removeAttribute("data-transition-speed"), X.wrapper.removeAttribute("data-background-transition"), X.viewport.classList.remove("reveal-viewport"), X.viewport.style.removeProperty("--slide-width"), X.viewport.style.removeProperty("--slide-height"), X.slides.style.removeProperty("width"), X.slides.style.removeProperty("height"), X.slides.style.removeProperty("zoom"), X.slides.style.removeProperty("left"), X.slides.style.removeProperty("top"), X.slides.style.removeProperty("bottom"), X.slides.style.removeProperty("right"), X.slides.style.removeProperty("transform"), Array.from(X.wrapper.querySelectorAll(R)).forEach((e)=>{
        ...
        function He(e) {
            Oe(), X.overlay = document.createElement("div"), X.overlay.classList.add("overlay"), X.overlay.classList.add("overlay-preview"), X.wrapper.appendChild(X.overlay), X.overlay.innerHTML = `<header>\n\t\t\t\t<a class="close" href="#"><span class="icon"></span></a>\n\t\t\t\t<a class="external" href="${e}" target="_blank"><span class="icon"></span></a>\n\t\t\t</header>\n\t\t\t<div class="spinner"></div>\n\t\t\t<div class="viewport">\n\t\t\t\t<iframe src="${e}"></iframe>\n\t\t\t\t<small class="viewport-inner">\n\t\t\t\t\t<span class="x-frame-error">Unable to load iframe. This is likely due to the site's policy (x-frame-options).</span>\n\t\t\t\t</small>\n\t\t\t</div>`, X.overlay.querySelector("iframe").addEventListener("load", (e)=>{
        ...
        function Be() {
            if (w.help) {
                ...
                let e = '<p class="title">Keyboard Shortcuts</p><br/>', t = se.getShortcuts(), i = se.getBindings();
        ...
        function Ue() {
            if (X.wrapper && !he.isPrintingPDF()) {
                if (!w.disableLayout) {
                    ...
                    const e = Ke(), t = O;
                    We(w.width, w.height), X.slides.style.width = e.width + "px", X.slides.style.height = e.height + "px", O = Math.min(e.presentationWidth / e.width, e.presentationHeight / e.height), O = Math.max(O, w.minScale), O = Math.min(O, w.maxScale), 1 === O ? (X.slides.style.zoom = "", X.slides.style.left = "", X.slides.style.top = "", X.slides.style.bottom = "", X.slides.style.right = "", De({
                        layout: ""
                    })) : (X.slides.style.zoom = "", X.slides.style.left = "50%", X.slides.style.top = "50%", X.slides.style.bottom = "auto", X.slides.style.right = "auto", De({
        ...
        function We(e, i) {
            t(X.slides, "section > .stretch, section > .r-stretch").forEach((t)=>{
                ...
                if (/(img|video)/gi.test(t.nodeName)) {
                    const i = t.naturalWidth || t.videoWidth, n = t.naturalHeight || t.videoHeight, s = Math.min(e / i, a / n);
        ...
        function Ge() {
            if (w.pause) {
                ...
                xt(), X.wrapper.classList.add("paused"), !1 === e && Ie({
                    type: "paused"
                });
            }
        }
        function Je() {
            const e = X.wrapper.classList.contains("paused");
            X.wrapper.classList.remove("paused"), Ct(), e && Ie({
                type: "resumed"
            });
        }
        function Qe(e) {
        ...
        function it(e, t, i, a) {
            ...
            let l = u !== r || v !== o;
            l || (p = null);
            let d = n[u], c = d.querySelectorAll("section");
            m = c[v] || d;
            let h = !1;
            l && p && m && !ne.isActive() && (p.hasAttribute("data-auto-animate") && m.hasAttribute("data-auto-animate") && p.getAttribute("data-auto-animate-id") === m.getAttribute("data-auto-animate-id") && !(u > r || v > o ? m : p).hasAttribute("data-auto-animate-restart") && (h = !0, X.slides.classList.add("disable-slide-transitions")), Y = "running"), ct(), Ue(), ne.isActive() && ne.update(), void 0 !== i && ae.goto(i), p && p !== m && (p.classList.remove("present"), p.setAttribute("aria-hidden", "true"), Ye() && setTimeout(()=>{
                bt().forEach((e)=>{
                    Ve(e, 0);
                });
            }, 0));
            e: for(let e = 0, t = z.length; e < t; e++){
                for(let t = 0; t < s.length; t++)if (s[t] === z[e]) {
                    s.splice(t, 1);
                    continue e;
                }
                X.viewport.classList.add(z[e]), Ie({
                    type: z[e]
                });
            }
            ...
            }), !l && p || (Z.stopEmbeddedContent(p), Z.startEmbeddedContent(m)), requestAnimationFrame(()=>{
                Ee(Re(m));
            }), le.update(), oe.update(), ve.update(), ie.update(), ie.updateParallax(), ee.update(), ae.update(), re.writeURL(), Ct(), h && (setTimeout(()=>{
                X.slides.classList.remove("disable-slide-transitions");
            }, 0), w.autoAnimate && te.run(p, m));
        }
        function at() {
            xe(), Ce(), Ue(), _ = w.autoSlide, Ct(), ie.create(), re.writeURL(), ae.sortAll(), oe.update(), le.update(), ct(), ve.update(), ve.updateVisibility(), ie.update(!0), ee.update(), Z.formatEmbeddedContent(), !1 === w.autoPlayMedia ? Z.stopEmbeddedContent(m, {
                unloadIframes: !1
            }) : Z.startEmbeddedContent(m), ne.isActive() && ne.layout();
        }
        function nt(e = m) {
        ...
        function ot(e, i) {
            let a = t(X.wrapper, e), n = a.length, s = he.isPrintingPDF(), r = !1, o = !1;
            if (n) {
                w.loop && (i >= n && (r = !0), (i %= n) < 0 && (i = n + i, o = !0)), i = Math.max(Math.min(i, n - 1), 0);
                for(let e = 0; e < n; e++){
                    let t = a[e], n = w.rtl && !je(t);
                    t.classList.remove("past"), t.classList.remove("present"), t.classList.remove("future"), t.setAttribute("hidden", ""), t.setAttribute("aria-hidden", "true"), t.querySelector("section") && t.classList.add("stack"), s ? t.classList.add("present") : e < i ? (t.classList.add(n ? "future" : "past"), w.fragments && lt(t)) : e > i ? (t.classList.add(n ? "past" : "future"), w.fragments && dt(t)) : e === i && w.fragments && (r ? dt(t) : o && lt(t));
                }
                let e = a[i], t = e.classList.contains("present");
                e.classList.add("present"), e.removeAttribute("hidden"), e.removeAttribute("aria-hidden"), t || Ie({
                    target: e,
                    type: "visible",
                    bubbles: !1
                });
        ...
        function ht({ includeFragments: e = !1  } = {}) {
            let t = X.wrapper.querySelectorAll(S), i = X.wrapper.querySelectorAll(A), a = {
                left: u > 0,
                right: u < t.length - 1,
                up: v > 0,
                down: v < i.length - 1
        ...
        function ut(e = m) {
            ...
            e: for(let a = 0; a < t.length; a++){
                let n = t[a], s = n.querySelectorAll("section");
        ...
        function vt(e) {
            let i, a = u, n = v;
            if (e) {
                let i = je(e), s = i ? e.parentNode : e, r = mt();
        ...
        function St(e, t) {
            let i = mt()[e], a = i && i.querySelectorAll("section");
        ...
        function Ct() {
            if (xt(), m && !1 !== w.autoSlide) {
                ...
                let i = e ? e.getAttribute("data-autoslide") : null, a = m.parentNode ? m.parentNode.getAttribute("data-autoslide") : null, n = m.getAttribute("data-autoslide");
                i ? _ = parseInt(i, 10) : n ? _ = parseInt(n, 10) : a ? _ = parseInt(a, 10) : (_ = w.autoSlide, 0 === m.querySelectorAll(".fragment").length && t(m, "video, audio").forEach((e)=>{
                    e.hasAttribute("data-autoplay") && _ && 1e3 * e.duration / e.playbackRate > _ && (_ = 1e3 * e.duration / e.playbackRate + 1e3);
                })), !_ || Q || Ze() || ne.isActive() || _e() && !ae.availableRoutes().next && !0 !== w.loop || (G = setTimeout(()=>{
                    "function" == typeof w.autoSlideMethod ? w.autoSlideMethod() : zt(), Ct();
                }, _), J = Date.now()), f && f.setPlaying(-1 !== G);
            }
        }
        function xt() {
            clearTimeout(G), G = -1;
        ...
        function Mt({ skipFragments: e = !1  } = {}) {
            C.hasNavigatedHorizontally = !0, w.rtl ? (ne.isActive() || e || !1 === ae.next()) && ht().left && it(u + 1, "grid" === w.navigationMode ? v : void 0) : (ne.isActive() || e || !1 === ae.prev()) && ht().left && it(u - 1, "grid" === w.navigationMode ? v : void 0);
        }
        function Dt({ skipFragments: e = !1  } = {}) {
            C.hasNavigatedHorizontally = !0, w.rtl ? (ne.isActive() || e || !1 === ae.prev()) && ht().right && it(u - 1, "grid" === w.navigationMode ? v : void 0) : (ne.isActive() || e || !1 === ae.next()) && ht().right && it(u + 1, "grid" === w.navigationMode ? v : void 0);
        }
        ...
        function zt({ skipFragments: e = !1  } = {}) {
            if (C.hasNavigatedHorizontally = !0, C.hasNavigatedVertically = !0, e || !1 === ae.next()) {
                let t = ht();
                t.down && t.right && w.loop && Xe() && (t.down = !1), t.down ? Tt({
                    skipFragments: e
                }) : w.rtl ? Mt({
                    skipFragments: e
                }) : Dt({
        ...
        function Bt(e) {
            "running" === Y && /section/gi.test(e.target.nodeName) && (Y = "idle", Ie({
        ...
        function Ot(e) {
            ...
            if (t) {
                const i = t.getAttribute("href"), a = re.getIndicesFromHash(i);
    ...
    let Y = X, _ = [];
    return Y.initialize = (e)=>(Object.assign(Y, new X(document.querySelector(".reveal"), e)), _.map((e)=>e(Y)), Y.initialize()), [
        "configure",
        "on",
        "off",
        "addEventListener",
    ...
    }), Y.isReady = ()=>!1, Y.VERSION = j, Y;
});

//# sourceMappingURL=index.e853dca5.js.map
